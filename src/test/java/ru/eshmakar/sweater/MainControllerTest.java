...
import ru.eshmakar.sweater.controller.MainController;
...
@WithUserDetails("admin") //будем выполнять тесты по имени этого учетного записи
...
public class MainControllerTest {
    ...
    public void mainPageTest() throws Exception{
        this.mockMvc.perform(get("/main")) //проверка на запрос аутентификации
                .andDo(print())
